...
fun FirstScreen(navController: NavController) {
    Column(modifier = Modifier
        ...
        Text(text = "台中高美濕地")
        Image(painter = painterResource(id = R.drawable.gaomei) , contentDescription ="image" )
...
fun SecondScreen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Text(text = "台中彩虹村")
        Image(painter = painterResource(id = R.drawable.rainbow) , contentDescription ="image" )
    }
...
fun ThirdScreen(navController: NavController) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = "台中武陵農場")
        Image(painter = painterResource(id = R.drawable.wuling) , contentDescription ="image" )
    }
